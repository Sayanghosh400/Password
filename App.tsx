...
const PasswordSchema = Yup.object().shape({
  passwordLength: Yup.number().min(4, 'Too Short!').max(16, 'Too Long!').required("This is a required field!"),
})
      ...
      <SafeAreaView style={styles.appContainer}>
        <View style={styles.formContainer}>
          ...
          <Formik
            ...
            onSubmit={values => {
              generatePasswordString(+values.passwordLength) //+ converts string to number
            }}
          >
            {({
              values,
